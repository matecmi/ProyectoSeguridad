    ...
    public function acciones(Request $request)
    {
        ...
        if($request ->ajax()){
            ...
            ->addColumn('action1', function($accion){
                ...
                $acciones ='<td id="tdTabla "> <button type="button" name="editAccion"  id="'.$accion->id.'" class="btn editar btn-sm formulario__label">EDITAR <i class="fa-sharp fa-solid fa-pen-to-square ml-1"></i> </button></td>';
                return $acciones;

            })
            ->addColumn('action2', function($accion){

                $acciones ='<td id="tdTabla"> <button type="button" name="deleteAccion" id="'.$accion->id.'" class="btn eliminar btn-sm formulario__label">ELIMINAR <i class="fa-solid fa-trash-can ml-1"></i> </button></td>';
