    ...
    public function comentario(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $comentario = Comentario::select(
                'comentarios.*',
                'tickets.situacion as ticket_estado',
            ...
            return Datatables::of($comentario)
                ->addColumn('action', function ($comentario) {
                    ...
                    $acciones = '<td id="tdTabla"> <button type="button" name="editComentario"  id="' . $comentario->id . '" class="btn editar btn-sm formulario__label">EDITAR <i class="fa-sharp fa-solid fa-pen-to-square ml-1"></i> </button></td>';

                    return $acciones;
                })
                ->addColumn('action2', function ($comentario) {

                    $acciones = '<td id="tdTabla"> <button type="button" name="deleteComentario" id="' . $comentario->id . '" class="btn eliminar btn-sm formulario__label">ELIMINAR <i class="fa-solid fa-trash-can ml-1"></i> </button></td>';
